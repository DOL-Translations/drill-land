// GameCube "Mr. Driller Drill Land" Japanese To English Translation

endian msb // GameCube PPC requires Big-Endian Encoding (Most Significant Bit)
output "../output/Mr. Driller Drill Land [E].iso", create
origin $000000; insert "../input/Mr. Driller Drill Land [J].iso" // Include Japanese Drill Land ISO
